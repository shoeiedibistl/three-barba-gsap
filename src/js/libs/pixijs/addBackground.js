...
export function addBackground(app) {
  ...
  // !!!!!! Это расположение фона нужно отцентровать и теоретически
  // можно будет параллаксить в соответствие с движением танка !!!!!!
  ...
  // Устанавливаем позицию фона в верхний левый угол
