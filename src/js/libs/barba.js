...
export const barbaUi = () => {
  ...
  const afterTransition = () => {
    return new Promise((resolve) => {
      setTimeout(() => {
        document.getElementById(transitionScreenID).classList.remove(transitionScreenActiveClass);
        resolve();
      }, transitionScreenDelay);
    });
  };
      ...
      views: [
        {
          ...
          //FRONT: ппри выходе со стр убираем
      ...
      transitions: [
        {
          ...
          leave(data) {
            document.getElementById(transitionScreenID).classList.add(transitionScreenActiveClass);
          },
